  ...
  content: {
    Home: {
      data: {
        ...
        2: {
          id: 2, name: "SqlDBComponent", class: "SqlDBComponent", html: "", typenode: false, inputs: { input_1: { connections: [ { node: "1", input: "output_1" } ] } },
          data: { componentId: "dynamic-activeSqlDBComponent", host: "", connectionName: "", database: "",  dbengine: "", namespace: "", tables: {}, primaryKeys: {} },
          outputs: { output_1: { connections: [ { node: "3", output: "input_1" } ] } }, pos_x: 176, pos_y: 97
        },
        3: {
          id: 3, name: "DuckDBOutput", html: "", class: "DuckDBOutput", typenode: false, data: { componentId: "dynamic-activeDuckDBOutput", database: "" },
