...
set-env:
	...
	@sed -i.bak -E "s#^[^|]*\|\|#localEnv = () => this.setConfigFile('$(ENV)') \|\|#" ./ui/config/app-setup.js && rm -f ./ui/config/app-setup.js.bak
...
set-dev: certs
	...
	@sed -i.bak -E "s#^[^|]*\|\|#localEnv = () => this.setConfigFile('dev') \|\|#" ./ui/config/app-setup.js && rm -f ./ui/config/app-setup.js.bak