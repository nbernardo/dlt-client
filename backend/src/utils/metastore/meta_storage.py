...
class MetaStore:
    ...
    @staticmethod
    def persist_catalog(tables, pipeline=None, load_info=None, additionals={}, catalog_exist = False):
        ...
        print(f'DEST_TABLES=__dest_tables__:{','.join(tables)}', flush=True) # Notify the main process about pipeline run completion
