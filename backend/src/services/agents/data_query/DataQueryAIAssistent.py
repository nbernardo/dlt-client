...
from services.agents.data_query.prompts.data_query import (
    SETUP_PROMPT, prev_answered as prev_ans, generate_sql_query as gen_sql
)
...
class DataQueryAIAssistent(AbstractAgent):
    ...
    agent_factory = None
    prev_answered = prev_ans
    generate_sql_query = gen_sql
