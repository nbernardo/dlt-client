...
@pipeline.route('/logs/pipeline/<pipeline_id>', methods=['GET'])
...
@pipeline.route('/logs/search', methods=['GET'])
def search_logs():
    """
...
@pipeline.route('/logs/correlation/<correlation_id>', methods=['GET'])
...
@pipeline.route('/logs/stats', methods=['GET'])
...
@pipeline.route('/logs/cleanup', methods=['POST'])
